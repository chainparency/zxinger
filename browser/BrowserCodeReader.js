...
var BrowserCodeReader = /** @class */ (function () {
    ...
    function BrowserCodeReader(reader, timeBetweenScansMillis, _hints) {
         ...
         */
        this._timeBetweenDecodingAttempts = 50;
    }
    Object.defineProperty(BrowserCodeReader.prototype, "hasNavigator", {
         ...
         */
        get: function () {
            return typeof navigator !== 'undefined.js'
        },
        enumerable: false,
        configurable: true
    });
    ...
    BrowserCodeReader.prototype.decodeOnce = function (element, retryIfNotFound, retryIfChecksumOrFormatError) {
        ...
        var loop = function (resolve, reject) {
            if (_this._stopAsyncDecode) {
                // console.log("Video stream has ended before any code could be detected")
            ...
            try {
                ...
                var ifNotFound = retryIfNotFound && (e instanceof NotFoundException || e.name == 'NotFoundException')
                var isChecksumOrFormatError = (e instanceof ChecksumException || e.name == 'NotFoundException' || e instanceof FormatException || e.name == 'FormatException')
    ...
    BrowserCodeReader.prototype.decodeBitmap = function (binaryBitmap) {
        console.log("BrowserCodeReader.decodeBitmap", this.reader)
    ...
    BrowserCodeReader.prototype.createCaptureCanvas = function (mediaElement) {
        ...
        canvasElement.style.width = width + 'px.js'
        canvasElement.style.height = height + 'px.js'
